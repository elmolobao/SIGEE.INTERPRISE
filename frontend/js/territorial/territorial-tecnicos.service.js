...
function exigir(){if(!autorizado())throw new Error('Cadastro de Técnicos disponível somente para Master.');const c=cliente();if(!c)throw new Error('Cliente Supabase indisponível.');return c;}
