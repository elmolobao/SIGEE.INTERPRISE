...
async function carregar(){const c=exigir();const [ma,ag,pe,ac,ta]=await Promise.all([
 ...
 const monitor=ma.data||[],agenda=ag.data||[],pesquisa=pe.data||[],acoes=ac.data||[],tarefas=ta.data||[];
...
window.SIGEE_TERRITORIAL_INDICADORES_SERVICE=Object.freeze({carregar,master,PESOS,classeDesempenho,versao:'RC11.3.16'});
})(window);
