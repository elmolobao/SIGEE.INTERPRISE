  ...
  function garantirPainel() {
    ...
    painel.innerHTML = `
      ...
      <article id="m5-conflitos-box" class="m5-conflitos-box hidden">
        ...
        <div class="m5-tabela-wrap"><table><thead><tr><th>Importar</th><th>Aluno</th><th>Escola</th><th>Data</th><th>Resultado</th><th>Observação</th></tr></thead><tbody id="m5-conflitos"></tbody></table></div>
      </article>
