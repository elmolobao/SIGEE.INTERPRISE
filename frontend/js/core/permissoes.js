...
(function (window) {
  ...
  const MATRIX = Object.freeze({
    Master: Object.freeze({ global:1, usuarios:1, logs:1, salaSituacao:1, relatorios:1, importarEscola:1, exportar:1, abrirSolicitacao:1, visualizarProcesso:1, moverProcesso:1, editarProcesso:1, excluirProcesso:1, regredirProcesso:1, cadastrarEscola:1, editarEscola:1 }),
    SEC: Object.freeze({ global:1, usuarios:0, logs:1, salaSituacao:1, relatorios:1, importarEscola:0, exportar:1, abrirSolicitacao:0, visualizarProcesso:1, moverProcesso:0, editarProcesso:0, excluirProcesso:0, regredirProcesso:0, cadastrarEscola:0, editarEscola:0 }),
    Gestor: Object.freeze({ global:1, usuarios:0, logs:0, salaSituacao:1, relatorios:1, importarEscola:0, exportar:1, abrirSolicitacao:0, visualizarProcesso:1, moverProcesso:0, editarProcesso:0, excluirProcesso:0, regredirProcesso:0, cadastrarEscola:0, editarEscola:0 }),
  ...
  const api = Object.freeze({ PERFIS: PROFILES, MATRIZ: MATRIX, normalizarPerfil: normalize, perfilAtual: profile, pode: can, ehGlobal: function (u) { return can('global', u); }, aplicarMenu: apply, instalarProtecoes: installGuards });
