/** SIGEE RC4.2 — Matriz única de permissões. */
(function(window){
'use strict';
...
window.SIGEE_PERMISSOES=Object.freeze({MATRIZ:M,normalizarPerfil:v=>window.SIGEE_SESSION?.normalizarPerfil?.(v)||'',obterUsuario:user,obterPerfil:profile,pode:can,aplicar:apply});
})(window);
