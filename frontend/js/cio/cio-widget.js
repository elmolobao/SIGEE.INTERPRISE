(function(global, document){
  ...
  function render(resultado){
    ...
    return `<div class="sigee-cio-widget-brief"><strong>${esc(resultado.resumo?.saudacao||'Resumo operacional')}</strong><p>${esc(resultado.resumo?.texto||'Análise concluída.')}</p></div>
      ...
      <section class="sigee-cio-section sigee-cio-territorial-section"><div class="sigee-cio-section-title"><div><h3>Monitoramento territorial</h3><p class="sigee-cio-legenda-titulo">Ordenado pelo maior volume de processos críticos.</p></div><button type="button" data-cio-lista="SEM_RESP">${m.semResponsavel?.length||0} aguardando atribuição</button></div><div class="sigee-cio-risco-legenda"><span class="normal">0–25 Normal</span><span class="medio">26–50 Atenção</span><span class="alto">51–75 Alto</span><span class="critico">76–100 Crítico</span></div><div class="sigee-cio-territorial">${territorial||'<p>Sem dados territoriais.</p>'}</div></section>
